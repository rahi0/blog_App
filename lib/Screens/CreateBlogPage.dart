...
/////////////////////////////
            ...
            //////////////////////// Create Button /////////////////////
            GestureDetector(
              onTap: isPressed ? null: createBlog,
              child: Container(
  ...
  void createBlog() async {
    ...
    if(titleController.text == "") {
      ...
      var data = {
          ...
          "date": "${DateFormat.yMMMMd().format(selectedDateTo)}",
        };
       print(data);

     var res = await CallApi().withoutTokenPostData(data, 'resource');
     ...
     if (res.statusCode != 201) {
      ...
      store.state.homeInfoState.add(body);
      setState(() {
          isPressed = false;
        });
        store.dispatch(new HomeInfoAction(store.state.homeInfoState));
